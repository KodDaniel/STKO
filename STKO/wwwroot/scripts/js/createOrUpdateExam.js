...
"use strict";
/*!**************************************************!*\
  !*** ./wwwroot/scripts/ts/createOrUpdateExam.ts ***!
  \**************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _userMessage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./userMessage */ "./wwwroot/scripts/ts/userMessage.ts");
/* harmony import */ var _formClientValidation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formClientValidation */ "./wwwroot/scripts/ts/formClientValidation.ts");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _sharedTypes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sharedTypes */ "./wwwroot/scripts/ts/sharedTypes.ts");




const form = (document.getElementById("CreateForm") ?? document.getElementById("UpdateForm"));
//När formulär postas 
form?.addEventListener("submit", (event) => {
    ...
    const examId = document.getElementById("ExamId")?.innerText.trim();
    //Används både för skapande och uppdatering
    const examName = document.getElementById("ExamName")?.value;
    const sendReminderDate = document.getElementById("SendReminderDate")?.value;
    const randomOrder = document.getElementById("RandomOrder").checked;
    const examTime = document.getElementById("ExamTime")?.value;
    jquery__WEBPACK_IMPORTED_MODULE_2__.ajax({
        type: (form.id === "CreateForm") ? _sharedTypes__WEBPACK_IMPORTED_MODULE_3__.HttpVerb.POST : _sharedTypes__WEBPACK_IMPORTED_MODULE_3__.HttpVerb.PUT,
        ...
        success: () => {
            const successMessage = new _userMessage__WEBPACK_IMPORTED_MODULE_0__.SuccessMessage("Provet har sparats", "saveExamSuccessMsg");
            form.insertAdjacentHTML("beforebegin", successMessage.getMessage);
            (form.id === "CreateForm") ?
                form.reset() : document.getElementById("ExamNameHeadline").innerText = examName;
            //JQuery 
            jquery__WEBPACK_IMPORTED_MODULE_2__(`#${successMessage.id}`)?.fadeOut(6000);
        },
        error: (response) => {
            if (response.status === 400 && response.responseJSON.title === "One or more validation errors occurred.") {
                const errors = response.responseJSON.errors;
                const errorMap = _formClientValidation__WEBPACK_IMPORTED_MODULE_1__.FormClientValidation.getValidationErrorElements(errors);
                //Placera valideringsfelen i formuläret
                errorMap.forEach((div, id) => {
                    const inputField = form?.querySelector(`#${id}`);
                    inputField?.insertAdjacentElement("beforebegin", div);
                    inputField?.classList.add('input-validation-error');
                });
            }
            else {
                const errorMessage = new _userMessage__WEBPACK_IMPORTED_MODULE_0__.ErrorMessage("Någonting gick fel", "saveExamErrorMsg");
...
/******/ })()
;
//# sourceMappingURL=createOrUpdateExam.js.map